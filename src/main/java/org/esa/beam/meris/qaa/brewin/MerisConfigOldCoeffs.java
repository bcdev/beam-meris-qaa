...
public class MerisConfigOldCoeffs implements SensorConfig {
    ...
    private static final double[] wavelengths = {412, 443, 490, 510, 560, 620};
    private static final double[] specificAbsorptions = {0.00469, 0.00721, 0.015, 0.0325, 0.0619, 0.2755};
