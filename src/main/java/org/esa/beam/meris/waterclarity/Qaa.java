...
class Qaa {
    ...
    public static final int[] WAVELENGTH = {412, 443, 490, 510, 560, 620, 665};
    ...
    public void qaaf_v5(float[] Rrs, float[] rrs, float[] a, float[] bbp) throws ImaginaryNumberException {
        ...
        float rat;
        float Y;
        float[] u = new float[Rrs.length]; //Modified by MZ, Nov-05-11
             //Rrs=stat
        ...
        //We may combine wavelengths 560nm and 670nm.
            ...
            //STEP 5 (b) ////////////////////////////////////////////////////////////////////////////////////
            for (int b = 0; b < Rrs.length - 1; b++) {
                bbp[b] = (float) (bbp670 * Math.pow((float) WAVELENGTH[IDX_670] / (float) WAVELENGTH[b], Y));
            }
            /////////////////////////////////////////////////////////////////////////////////////////////////
        }
        ...
        //    float alpha490 = a[IDX_490];    y.jiang
         ...
         //   float bb490  = bb[IDX_490];      y.jiang
           ...
           // for(int i = 0; i < t.length; i++){
            ...
            if(Q<0) throw new ImaginaryNumberException("Q<0",Q);
         ...
         /*
                //  FIND Z1
                    ...
                    temp1 = (float)(  (y1 / (3*1))  );
                    temp1=0-temp1;
                    temp2 = (float)(  ( Math.pow(2,(1/3))*( -(y1*y1) + (2*1)*y2)  ) /
                                      ( (3*1) *
                                         Math.pow( (
                                            (-2*Math.pow(y1,3) ) + 9*1*y1*y2 - 27 * y3 +
                                                Math.sqrt(  4*Math.pow( (-(y1*y1) + 3*1*y2),3) +
                                                              Math.pow( ( (-2*Math.pow(y1,3) ) + 9*1*y1*y2  -
                                                                          (27 * y3)),2)  )
                                            ),(1/3))
                                       )
                                    );
                    temp3 = (float)(    Math.pow((  (-2*Math.pow(y1,3) + 9*1*y1*y2 - 27*y3 +
                                                     Math.sqrt( 4*Math.pow( (-2*(y1*y1)) + 3*1*y2, 3) +
                                                                  Math.pow( (-2*Math.pow(y1,3) + 9*1*y1*y2 -
                                                                      27*y3
                                                                  ),2))
                                                     )
              ...
              //  if(z1[i]<0)  throw new NegativeNumberException("Will produce an negative number", z1[i]);
                    z1 = temp1 - temp2 + temp3;
        double determin=  4*Math.pow( (-2*(y1*y1)) + 3*1*y2, 3) +
                                                                  Math.pow( (-2*Math.pow(y1,3) + 9*1*y1*y2 -
                                                                      27*y3),2);

         //  FIND Z2
                    temp2 =  (float)(   (1 + imaginary*Math.pow(3,(1/3)) * (-2*Math.pow(y1,3) + 3*1*y2))  /
                                        (Math.pow(32,(2/3) * 1) *
                                         Math.pow( (
                                            (-2*Math.pow(y1,3) ) + 9*1*y1*y2 - 27*Math.pow(1,2) * y3 +
                                                Math.sqrt(  4*Math.pow( (-Math.pow(y1,2) + 3*1*y2),3) +
                                                              Math.pow( ( (-2*Math.pow(y1,3) ) + 9*1*y1*y2  +
                                                                          (27*Math.pow(1,2) * y3)
                                                              ),2)  )
                                            ),(1/3))
                                    ));
                    temp3 = (float)(  (  1 - imaginary*Math.pow(3,(1/3)) *
                                         Math.pow(( (-2*Math.pow(y1,3) + 9*1*y1*y2 - 27*Math.pow(1,2)*y3 +
                                                     Math.sqrt( 4*Math.pow( (-2*Math.pow(y1,2)) + 3*1*y2, 3) +
                                                          Math.pow( (-2*Math.pow(y1,3) + 9*1*y1*y2 -
                                                              27*Math.pow(1,2)*y3 ),2))
                                            )  ),(1/3)  )       /
                                        Math.pow(62,(1/3))
                                    ));
                    z2 = temp1 + temp2 + temp3;
