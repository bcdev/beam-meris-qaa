...
public class Qaa {
    ...
    public void qaaf_v5(float[] Rrs, float[] rrs, float[] a, float[] bbp) throws org.esa.beam.meris.waterclarity.ImaginaryNumberException {
        ...
        for (int b = 0; b < Rrs.length; b++) { //Modified by MZ, Nov-05-11
            ...
            if (nom >= 0) {
                ...
                throw new org.esa.beam.meris.waterclarity.ImaginaryNumberException("Will produce an imaginary number", nom);
            }
        }
        ...
        if (Rrs[IDX_670] < 0.0015) { //Old QAA_v5
            ...
            result = numer / denom;
            if (result <= 0) {
                throw new org.esa.beam.meris.waterclarity.ImaginaryNumberException("Will produce an imaginary number", result);
            }
    ...
    public float qaaf_zeu(float alpha490, float bb490, float theta,int waterClar) throws org.esa.beam.meris.waterclarity.ImaginaryNumberException { //y.jiang
        ...
        if(Q<0) throw new org.esa.beam.meris.waterclarity.ImaginaryNumberException("Q<0",Q);
